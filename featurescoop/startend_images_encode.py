...
def main(args):
  ...
  print_message('Classifying images from %s' % args.start, type='important', line='new')
...
if __name__ == "__main__":
  ...
  parser.add_argument('-s', '--start', type=str, required=True, help='Source folder containing images for starting the path')
  parser.add_argument('-e', '--end', type=str, required=True, help='Source folder containing images for ending the path')
