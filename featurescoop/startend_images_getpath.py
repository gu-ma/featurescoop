...
def main(args):
    ...
    img1_closest_id = features_get_closest_image(
        pca_features, feature=img1_feat, num_results=args.n
    )[int(args.n * random.random())]
    img2_closest_id = features_get_closest_image(
        pca_features, feature=img2_feat, num_results=args.n
    )[int(args.n * random.random())]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-n", type=int, help="Number of neighbouring images", default=10
    )
